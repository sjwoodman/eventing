...
for [Channels](spec.md#kind-channel) and [ChannelProvisioners](spec.md#kind-ChannelProvisioner)
...
- **ChannelProvisioners** implement strategies for realizing backing resources
...
<img alt="Resource Types ChannelProvisioners" src="images/resource-types-provisioner.svg" width="200">
...
**ChannelProvisioner** catalogs available implementations of _Channels_.
_ChannelProvisioners_ hold a JSON Schema that is used to validate the _Channel_
input arguments. _ChannelProvisioners_ make it possible to provide cluster wide
defaults for the _Channels_ they provision.

_ChannelProvisioners_ do not directly handle events. They are 1:N with
_Channels_.

For more details, see [Kind:
ChannelProvisioner](spec.md#kind-cluster-provisioner).
